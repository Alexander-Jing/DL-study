...
# 激活函数，放在中间，防止模型变成线性的，但是输出就没必要了，使用softmax就可以了
# sigmoid 函数：软化版本的(0,1)
# tanh函数，软化版本的(-1,1)
# relu函数，软化版本的(0,+inf) max(x,0)。算起来快，不需要指数运算
...
if __name__ == '__main__':
    ...
    net = nn.Sequential(nn.Flatten(), nn.Linear(784, 256), nn.ReLU(), nn.Linear(256, 10), nn.Softmax())  # 多层感知机的模型
